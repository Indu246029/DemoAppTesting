...
public class BasePageTest {
    ...
    public BasePageTest(){
        this.driver = new DriverManagerTest().getDriver();
        PageFactory.initElements(new AppiumFieldDecorator(this.driver), this);
    }

    public void waitForVisibility(MobileElement e) {
        WebDriverWait wait = new WebDriverWait(driver, TestUtilsTest.WAIT);
    ...
    public void waitForSecond(long seconds) throws InterruptedException {
    ...
    public WebElement getMobileImageElementByClassName(int index){
        return driver.findElements(By.className("android.widget.ImageView")).get(index);
    }
    public WebElement getMobileTextElementByClassName(int index){
        return driver.findElements(By.className("android.widget.TextView")).get(index);
    }
    ...
    public WebElement getIosTextElement(String text){
        String xPath = "//XCUIElementTypeStaticText[@name=\""+text+"\"]";
        System.out.println(xPath);
        return driver.findElement(By.xpath(xPath));
    }
    public WebElement getAndroidContentDescElement(String text){
        String xPath = "//android.widget.TextView[@content-desc=\""+text+"\"]";
        return driver.findElement(By.xpath(xPath));
    }
    public WebElement getAndroidTextElement(String text){
        String xPath = "//android.widget.TextView[@text=\""+text+"\"]";
        return driver.findElement(By.xpath(xPath));
    }
    public WebElement getIosOtherElement(String text){
        String xPath = "//XCUIElementTypeOther[@name=\""+text+"\"]";
        return driver.findElement(By.xpath(xPath));
    }
    ...
    public String getText(MobileElement e, String msg) {
        String txt;
        switch(new GlobalParamsTest().getPlatformName()){
            case "Android":
            ...
            case "iOS":
                ...
                break;
            default:
                throw new IllegalStateException("Unexpected value: " + new GlobalParamsTest().getPlatformName());
        }
...
//        scrollObject.put("toVisible", "sdfnjksdnfkld");sdfnjksdnfkld
