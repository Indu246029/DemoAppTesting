...
public class CapabilitiesManagerTest {
    ...
    public DesiredCapabilities getCaps() throws IOException {
        ...
        Properties props = new PropertyManagerTest().getProps();
            ...
            switch(params.getPlatformName()){
                ...
                case "iOS":
                    ...
                    String iOSAppUrl = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test"
                            + File.separator + "resources" + File.separator + "apps" + File.separator + "PedsGuide.ipa";
                    utils.log().info("appUrl is" + iOSAppUrl);
                    caps.setCapability("bundleId", props.getProperty("iOSBundleId"));
                    caps.setCapability("wdaLocalPort", params.getWdaLocalPort());
                    caps.setCapability("webkitDebugProxyPort", params.getWebkitDebugProxyPort());
                    caps.setCapability("app", iOSAppUrl);
                    caps.setCapability("xcodeOrgId",props.getProperty("xcodeOrgId"));
                    caps.setCapability("xcodeSigningId",props.getProperty("xcodeSigningId"));
                    caps.setCapability("updatedWDABundleId",props.getProperty("updatedWDABundleId"));
                    break;
            }
            return caps;
        } catch(Exception e){
